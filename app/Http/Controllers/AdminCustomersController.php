<?php namespace App\Http\Controllers;
	...
	class AdminCustomersController extends \crocodicstudio\crudbooster\controllers\CBController {
	    ...
	    public function cbInit() {
			...
			$this->col = [];
			$this->col[] = ["label"=>"Customer Name","name"=>"custname"];
			$this->col[] = ["label"=>"Join Date","name"=>"joindate"];
			...
			$this->form = [];
			$this->form[] = ['label'=>'Customer Name','name'=>'custname','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
			$this->form[] = ['label'=>'Join Date','name'=>'joindate','type'=>'text','validation'=>'required|min:1|max:255','width'=>'col-sm-10'];
